...
- Weeks he could be primary or backup (week-of Monday): 11/9, 11/23, 12/7, 12/21, 12/28, 1/11, 1/25, 2/8, 2/22, 3/8, 3/22, 3/29, 4/12, 4/26, 5/10, 5/24, (6/7 tentative vacation), 6/21, 6/28. He does **not** want all of them. ⟶ **B10 (9/23): his Feb–Apr 2027 weeks (2/8, 2/22, 3/8, 3/22, 3/29, 4/12, 4/26) stay a rule** — `surgeonRules.s4.availableWeeks` (primary-only `outside-available-weeks` off them, backup open) — **until he paints the second period himself**: the second period (Feb 2027 – Apr 2027) has no offer of his and no mode, so he is *not started* there and the weeks list governs; the first period read them as `either` offers under `exhaustive` (§8 item 15 / item 20), which is the pattern he should not repeat — paint, or be set `preferred`.
...
5. **Philip's monthly cap** — none stated; the group default (8 primary) applies from November although his own October was 15 days. ⟶ B10 (9/23): and his **Feb–Apr 2027 weeks remain a rule** (`availableWeeks`, §3) for the second period until he paints it — he has no offer and no mode there, so he is *not started* and the list governs primary; ask him to paint (or set him `preferred`) before the 12/21 freeze rather than importing the weeks as `either` offers again (item 15's consequence).
