...
- **Thanksgiving 2026: Khan takes Thu 11/26 – Sun 11/29 as one unit, primary** — recorded by Claude Code on 2026-09-22 as an evening decision; the daytime record said pending; Faraz to re-confirm before publish (locked in the seed; ⟶ Prompt 12 B: the four `existingAssignments` rows carry `awaitingConfirmation: true`, the importer writes their `schedule_days` note as `awaiting confirmation - seed: faraz-2026-09-21 - …`, and the month grid and day editor show a "confirm" badge on them until he confirms; if he declines, the four days are unlocked — primary null, locked false — and the unit shrinks to Thu 11/26 only; open question #8).
...
| Thanksgiving | major | **Thu 11/26 – Sun 11/29 (one unit; Khan primary — recorded by Claude Code on 2026-09-22 as an evening decision; the daytime record said pending; Faraz to re-confirm before publish, Prompt 12 B)** | Acton never (opted out); Philip ≤ 1 major; backup: anyone not opted out |
